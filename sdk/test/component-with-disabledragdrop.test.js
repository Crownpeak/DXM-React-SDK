...
const file1 = path.resolve('./test/fixtures/component-with-disabledragdroptrue.js');
const content1 = fs.readFileSync(file1, 'utf8');
const { components: components1, uploads: uploads1 } = parser.parse(content1, file1);

const file2 = path.resolve('./test/fixtures/component-with-disabledragdropfalse.js');
const content2 = fs.readFileSync(file2, 'utf8');
const { components: components2, uploads: uploads2 } = parser.parse(content2, file2);

const file3 = path.resolve('./test/fixtures/component-with-disabledragdropundefined.js');
